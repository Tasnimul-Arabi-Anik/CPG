...
| Statistical modeling | 10,006 spot-test pairs support H1 initial-interaction benchmarking; H3 has descriptive spot breadth; H4 is blocked | Spot tests are not productive infection, and current H1 module identity signatures do not robustly beat genome-similarity plus K/O baselines | Leakage-safe grouped analyses with appropriate outcomes, uncertainty, and claim audits after each evidence expansion | H1 benchmark implemented; H4 blocked |
