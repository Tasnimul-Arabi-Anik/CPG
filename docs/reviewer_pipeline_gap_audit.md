...
| Defense/counter-defense | DefenseFinder host-defense evidence is available for 200/200 assay hosts with 2,758 normalized system-level rows; Phold ACR anti-CRISPR evidence is available for 7/105 assay phages; annotation-keyword phage anti-defense screening remains non-accepted | Intracellular compatibility claims are still blocked because phage anti-defense evidence is sparse and productive-infection/plaque/EOP labels are absent | Expanded curated phage anti-defense evidence plus productive-infection outcomes; optional PADLOC cross-check for host defense | Partial production evidence |
| Statistical modeling | PhageHostLearn spot-test outcomes support initial-interaction and descriptive panel-breadth audits; candidate-level RBPbase, PHROGs/MMseqs domain, and partial Phold/Foldseek structural evidence are available for the benchmark phages; H4 productive-infection models remain blocked | Spot breadth, receptor candidate features, host-defense evidence, and sparse anti-CRISPR candidate evidence are available, but counter-defense coverage, final public-scale taxonomy, and productive-infection labels remain insufficient | Keep grouped receptor modeling exploratory; H4 still requires plaque, EOP, propagation, or productive-infection outcomes | In progress |
...
5. Expand curated phage counter-defense evidence and add productive-infection labels after preserving the claim boundary; host-defense evidence and sparse Phold ACR anti-CRISPR candidates are now available for the benchmark.
