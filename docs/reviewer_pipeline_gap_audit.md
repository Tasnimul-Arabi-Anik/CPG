...
| Defense/counter-defense | DefenseFinder host-defense evidence is available for 200/200 assay hosts with 2,758 normalized system-level rows; annotation-keyword phage anti-defense screening remains non-accepted | Intracellular compatibility claims are still blocked without explicit phage anti-defense evidence and productive-infection/plaque/EOP labels | Curated phage anti-defense evidence plus productive-infection outcomes; optional PADLOC cross-check for host defense | Partial production evidence |
...
5. Add curated phage counter-defense evidence and productive-infection labels after preserving the claim boundary; host-defense evidence is now available for the benchmark hosts.
