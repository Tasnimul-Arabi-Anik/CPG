...
- Host-defense annotations are now available from DefenseFinder for the benchmark assay hosts, and sparse Phold ACR anti-CRISPR candidates are available for 7/105 assay phages. Phage counter-defense annotations remain incomplete because many anti-defense genes remain undiscovered and the current ACR calls are computational candidates only. Annotation-keyword anti-defense hits are screening candidates only and are not accepted as counter-defense compatibility evidence.
...
The seed profile contains reviewed spot-test outcomes, and the production profile now has reviewed PhageHostLearn K/O result rows for 200/200 assay hosts (Typeable K 196/200; Typeable O 191/200), ST/AMR/virulence context for 188/200 assay hosts, baseline Prodigal CDS predictions for 105/105 assay phages, PHROGs/MMseqs domain-profile evidence, and partial Phold/Foldseek structural evidence. These phage-side features remain computational candidate support, not validated RBP/depolymerase function. Sparse phage counter-defense evidence must be interpreted as limited coverage, not as broad biological absence. Keyword-only anti-defense screening must not be treated as accepted counter-defense evidence. H3 therefore has descriptive spot-breadth values, candidate receptor features, and limited anti-CRISPR evidence, but no supported counter-defense enrichment or productive-infection claim.
