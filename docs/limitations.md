...
- Host-defense annotations are now available from DefenseFinder for the benchmark assay hosts, but phage counter-defense annotations remain incomplete because many anti-defense genes remain undiscovered. Annotation-keyword anti-defense hits are screening candidates only and are not accepted as counter-defense compatibility evidence.
