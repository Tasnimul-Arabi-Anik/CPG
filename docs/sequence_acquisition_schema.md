...
| `raw_sequence_exists` | Whether `raw_sequence_path` currently exists. |
...
| Status | Meaning |
| --- | --- |
| `local_sequence_available` | `raw_sequence_path` exists and can be checked by sequence QC. |
