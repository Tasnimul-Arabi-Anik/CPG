...
REQUIRED_DOCS = [
    ...
    "docs/phagehostlearn_readiness_schema.md",
    "docs/phagehostlearn_host_archive_schema.md",
...
REQUIRED_SCRIPTS = [
    ...
    "scripts/audit_phagehostlearn_readiness.py",
    "scripts/self_test_phagehostlearn_readiness.py",
    "scripts/audit_phagehostlearn_host_archive.py",
    "scripts/self_test_phagehostlearn_host_archive.py",
