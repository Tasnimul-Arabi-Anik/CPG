...
REQUIRED_OUTPUTS = [
    ...
    ("stage_9_workflow_config_self_test", "results/validation/workflow_config_self_test.tsv", ["test_id", "scenario", "expected_status", "observed_status", "status"]),
    ("stage_9_workflow_config_self_test_report", "results/validation/workflow_config_self_test_report.tsv", ["severity", "item", "message"]),
    ...
    ("stage_9_external_evidence_acceptance_self_test", "results/validation/external_evidence_acceptance_self_test.tsv", ["test_id", "scenario", "expected_acceptance_status", "observed_acceptance_status", "expected_content_lint_contains", "observed_content_lint", "status"]),
    ...
    ("stage_9_rbp_external_evidence_normalization_self_test", "results/validation/rbp_external_evidence_normalization_self_test.tsv", ["test_id", "scenario", "expected_domain_rows", "observed_domain_rows", "status"]),
    ...
    ("stage_9_phage_host_assay_import_self_test", "results/validation/phage_host_assay_import_self_test.tsv", ["test_id", "scenario", "expected_status", "observed_status", "status"]),
    ("stage_9_phage_host_assay_import_self_test_report", "results/validation/phage_host_assay_import_self_test_report.tsv", ["severity", "item", "message"]),
    ...
    ("stage_0_assay_import_report", "results/qc/assay_import_report.tsv", ["severity", "import_id", "input_path", "output_path", "message"]),
    ("stage_0_imported_phage_host_assays", "results/metadata/phage_host_assays.tsv", ["interaction_id", "phage_id", "host_id", "study_id", "assay_type", "tested"]),
    ("stage_0_imported_phage_host_relationships", "results/metadata/phage_host_relationships.tsv", ["relationship_id", "phage_id", "host_id", "relationship_type", "relationship_status"]),
    ...
    ("stage_1_external_evidence_acceptance", "results/qc/external_evidence_acceptance.tsv", ["evidence_id", "acceptance_status", "blocking_issue", "provenance_lint", "content_lint", "next_action"]),
    ...
    ("stage_5_phage_host_relationships", "results/host_features/phage_host_relationships.tsv", ["relationship_id", "phage_id", "host_id", "relationship_type", "relationship_status", "relationship_evidence", "source_reference", "notes"]),
...
REQUIRED_DOCS = [
    ...
    "docs/genome_sequence_qc_self_test_schema.md",
    ...
    "docs/rbp_external_evidence_normalization_schema.md",
    "docs/rbp_external_evidence_normalization_self_test_schema.md",
    "docs/defense_external_evidence_normalization_schema.md",
    "docs/defense_external_evidence_normalization_self_test_schema.md",
    "docs/assay_matrix_normalization_schema.md",
    "docs/assay_matrix_mapping_template_schema.md",
    "docs/phagehostlearn_source_export_schema.md",
    "docs/phagehostlearn_dataset_audit_schema.md",
    "docs/phagehostlearn_host_typing_evidence_self_test_schema.md",
    "docs/phagehostlearn_phage_cds_annotation_self_test_schema.md",
    ...
    "docs/workflow_config_self_test_schema.md",
...
REQUIRED_SCRIPTS = [
    ...
    "scripts/self_test_workflow_config.py",
    ...
    "scripts/normalize_assay_matrix.py",
    "scripts/self_test_assay_matrix_normalization.py",
    "scripts/create_assay_matrix_mapping_templates.py",
    "scripts/self_test_assay_matrix_mapping_templates.py",
    "scripts/create_phagehostlearn_source_exports.py",
    "scripts/self_test_phagehostlearn_source_exports.py",
    "scripts/audit_phagehostlearn_dataset.py",
    "scripts/self_test_phagehostlearn_dataset.py",
    "scripts/build_phagehostlearn_host_typing_evidence.py",
    "scripts/self_test_phagehostlearn_host_typing_evidence.py",
    "scripts/build_phagehostlearn_phage_cds_annotations.py",
    "scripts/self_test_phagehostlearn_phage_cds_annotations.py",
    "scripts/import_phage_host_assays.py",
    "scripts/self_test_phage_host_assay_import.py",
    ...
    "scripts/self_test_genome_sequence_qc.py",
    ...
    "scripts/normalize_rbp_external_evidence.py",
    "scripts/normalize_defense_external_evidence.py",
...
REQUIRED_CONFIGS = [
    ...
    "config/tools.yaml",
    "config/assay_imports.yaml",
    "config/assay_imports.mock.yaml",
